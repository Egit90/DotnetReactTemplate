...
public class SignInExternalEndpoint<TUser> : IAuthEndpoint where TUser : IdentityUser, ICrystalUser, new()
{
    public RouteHandlerBuilder Map(IEndpointRouteBuilder builder)
    {
        return builder.MapPost("/signin/external",
                ...
                {
                    await context.SignOutAsync(CrystalAuthSchemeDefaults.SignInExternalScheme);
                    await context.SignOutAsync(CrystalAuthSchemeDefaults.SignUpExternalScheme);
                    ...
                    if (CrystalOptions.Internal.CustomExternalSignUpFlow)
                    {
            ...
            .RequireAuthorization(b =>
            {
                ...
                b.AddAuthenticationSchemes(CrystalAuthSchemeDefaults.SignInExternalScheme);
            });
    }
}
