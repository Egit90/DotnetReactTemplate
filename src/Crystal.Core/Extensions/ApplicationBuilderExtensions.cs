...
{
    /// <summary>
    /// Registers all Crystal endpoints
    /// </summary>
    /// <param name="app"></param>
    /// <param name="configure"></param>
    public static void MapCrystalEndpoints(this WebApplication app, Action<EndpointsConfiguration>? configure = null)
    {
        var opts = app.Services.GetRequiredService<IOptions<CrystalOptions>>().Value;
